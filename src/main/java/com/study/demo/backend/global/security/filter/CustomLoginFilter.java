...
import com.study.demo.backend.domain.auth.dto.request.AuthReqDTO;
...
public class CustomLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(@NonNull HttpServletRequest request,
        ...
        AuthReqDTO.Login requestBody;

        try {
            // Request Body를 읽어 DTO로 변환
            requestBody = objectMapper.readValue(request.getInputStream(), AuthReqDTO.Login.class);
        } catch (IOException e) {
        ...
        String loginId = requestBody.email();
